...
//for store object in two language
export class TwoVersionObject extends VersionObject {
  ruVersion: string;//ru version of language,education type, universtiy name,location
  uzVersion: string;//uz version of language,education type, universtiy name,location
}
//for displaying in ui
export class OneVersionObject extends VersionObject {
  version: string;// version of language,education type, universtiy name,location
}

export class ModelDictionary {
  static location: {
    [id: number]: ModelDictionary;
  } = {
